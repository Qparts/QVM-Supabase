...
BEGIN
  ...
  WITH filtered_quotations AS (
    ...
    WHERE
      ...
      AND (
        p_search IS NULL
        OR q.order_number ILIKE concat(chr(37), p_search, chr(37))
        OR q.plate_number ILIKE concat(chr(37), p_search, chr(37))
      )
  ),
          ...
          jsonb_build_object(
            ...
            'items', (
              ...
              WHERE qi.quotation_id = fwb.quotation_id
                ...
                AND (
                  p_search IS NULL
                  OR qi.part_number ILIKE concat(chr(37), p_search, chr(37))
                  OR qi.part_description ILIKE concat(chr(37), p_search, chr(37))
                  OR qi.vin ILIKE concat(chr(37), p_search, chr(37))
                  OR ci.final_part_number ILIKE concat(chr(37), p_search, chr(37))
                )
            ),
            'quotation_notes', (
              SELECT jsonb_agg(
