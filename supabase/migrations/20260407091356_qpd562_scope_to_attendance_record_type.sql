-- Synced from QVM/test branch applied migration history (version 20260407091356, name: qpd562_scope_to_attendance_record_type)
BEGIN;

SET search_path TO qvm_new_apps, public;

-- Update availability function to scope record_type to the 'attendance_record_type' list
...
-- Update RPC to resolve type IDs by the 'attendance_record_type' list
