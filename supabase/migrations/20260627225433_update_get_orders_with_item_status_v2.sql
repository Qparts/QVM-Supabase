-- Synced from QVM/test branch applied migration history (version 20260627225433, name: update_get_orders_with_item_status_v2)
BEGIN;
...
BEGIN
  ...
  FROM (
    ...
    LEFT JOIN LATERAL (
      SELECT qi.quotation_item_id, qi.customer_id, qi.part_description, qi.part_number
      FROM qvm_new_apps.quotation_items qi
