-- Synced from QVM/test branch applied migration history (version 20260407101428, name: qpd445_fix_dayoff_table_and_functions)
BEGIN;

SET search_path TO qvm_new_apps, public;

-- New table specific for Account Manager weekly day-offs
...
-- Dashboard RPC using the new table
...
-- Upload-replace RPC using the new table
