-- Synced from QVM/test branch applied migration history (version 20260310112816, name: update_rfq_dashboard_sorting_pagination)
...
REVOKE EXECUTE ON FUNCTION public.rfq_dashboard(
  uuid, text, text, text, text, uuid, timestamptz, timestamptz, integer, integer, text, text
) FROM public, anon;
