-- Synced from QVM/test branch applied migration history (version 20260717193232, name: qvm_vendor_login_empty_token_columns)

-- GoTrue scans confirmation_token/recovery_token/email_change/* as non-null strings and fails to
-- log in a user whose columns are NULL. Insert them as '' (matching admin-API-created accounts).
