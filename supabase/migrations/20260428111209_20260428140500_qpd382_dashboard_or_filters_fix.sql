-- Synced from QVM/test branch applied migration history (version 20260428111209, name: 20260428140500_qpd382_dashboard_or_filters_fix)
-- QPD-382: Purchase & Return Invoices Dashboard - OR semantics when both missing flags are selected (preserve latest features)
BEGIN;
