-- The pricing page counts the notes on a line.
--
-- The line's detail on the pricing page now carries its notes thread, so the item row reports how
-- many notes it has — every note, internal ones included, since this is the buying desk's page.
