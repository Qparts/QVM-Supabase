-- Synced from QVM/test branch applied migration history (version 20260701214321, name: qpd_add_item_pk_to_quotation_items_and_function)
-- 1) Add nullable item_pk column to quotation_items
ALTER TABLE qvm_new_apps.quotation_items
ADD COLUMN IF NOT EXISTS item_pk text NULL;

-- 2) Update the create_quotation_items function to accept item_PK from JSON
