-- Restore public.get_confirmed_orders_dashboard to use the confirmed order created_at
-- (confirmed_orders.created_at) for default sorting and return status as 'success' to match the frontend check.
