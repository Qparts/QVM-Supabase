...
-- New RPC that mirrors get_internal_dashboard but excludes soft-deleted notes
CREATE OR REPLACE FUNCTION public.get_internal_dashboard_v2(
  p_user_id uuid,
...
REVOKE EXECUTE ON FUNCTION public.get_internal_dashboard_v2(uuid, text, timestamptz, timestamptz, uuid[], int[], int[], int[], int[], text, text, int, int) FROM public, anon;
GRANT EXECUTE ON FUNCTION public.get_internal_dashboard_v2(uuid, text, timestamptz, timestamptz, uuid[], int[], int[], int[], int[], text, text, int, int) TO authenticated;
