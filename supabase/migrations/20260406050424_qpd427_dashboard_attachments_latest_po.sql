-- Synced from QVM/test branch applied migration history (version 20260406050424, name: qpd427_dashboard_attachments_latest_po)
-- QPD-427: Show only attachments for latest PO per item (fix Replace behavior)
BEGIN;
