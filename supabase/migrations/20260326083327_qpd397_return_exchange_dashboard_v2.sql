-- Synced from QVM/test branch applied migration history (version 20260326083327, name: qpd397_return_exchange_dashboard_v2)
...
BEGIN
  WITH user_ctx AS (
    ...
    SELECT 
      ...
      ci.approved_qty,
      coalesce(ci.part_description, qi.part_description) AS part_description,
