...
-- 8. get_vendor_emails / list_vendor_branches already exist for the send-modal to use to
--    populate branch options and notify the right recipients (no change needed here).
