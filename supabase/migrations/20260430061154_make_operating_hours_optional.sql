-- Synced from QVM/test branch applied migration history (version 20260430061154, name: make_operating_hours_optional)
-- Make operating_hours optional in create_vendor RPC
