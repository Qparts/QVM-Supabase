-- Fix: vendor_name was incorrectly joined from list_data instead of vendors table.
--      invoice_uploaded_by_name and creditnote_uploaded_by_name were missing from output.
BEGIN;
...
BEGIN
  ...
  user_ctx AS (
    ...
    FROM (
      SELECT vcn.purchase_order_id, vcn.uploaded_by,
    ...
    LEFT JOIN latest_vcn_by_po vcnpo ON vcnpo.purchase_order_id = lpo.purchase_order_id
