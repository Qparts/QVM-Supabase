-- Synced from QVM/test branch applied migration history (version 20260406112949, name: qpd422_save_vendor)
BEGIN;

SET search_path TO qvm_new_apps, public;

-- Extend vendors table with missing fields for edit feature
...
REVOKE ALL ON FUNCTION public.save_vendor(uuid, integer, jsonb) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.save_vendor(uuid, integer, jsonb) TO authenticated;
