...
REVOKE ALL ON FUNCTION public.get_archive_note_rows(text, text, integer) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_archive_note_rows(text, text, integer) TO service_role;
