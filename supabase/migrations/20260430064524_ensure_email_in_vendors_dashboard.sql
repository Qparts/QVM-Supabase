-- Synced from QVM/test branch applied migration history (version 20260430064524, name: ensure_email_in_vendors_dashboard)
-- Ensure email and phone_numbers are returned in get_vendors_dashboard
