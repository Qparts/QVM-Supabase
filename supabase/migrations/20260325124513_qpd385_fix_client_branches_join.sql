-- Synced from QVM/test branch applied migration history (version 20260325124513, name: qpd385_fix_client_branches_join)
-- QPD-385: Fix client_branches join key in get_purchase_invoices_dashboard
