-- Synced from QVM/test branch applied migration history (version 20260315102909, name: delivered_orders_dashboard_sorting_fix)
-- Update sorting to use fallback dates and deterministic tie-breakers
