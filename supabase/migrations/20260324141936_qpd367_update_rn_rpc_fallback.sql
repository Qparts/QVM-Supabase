-- Synced from QVM/test branch applied migration history (version 20260324141936, name: qpd367_update_rn_rpc_fallback)
-- QPD-367: Update get_return_note to fallback via return_items when no returns row is found directly
