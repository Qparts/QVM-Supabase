-- Synced from QVM/test branch applied migration history (version 20260310150510, name: orders_dashboard_fix_ld_order_type)
  ...
  WITH filtered_orders AS (
    SELECT
      jsonb_build_object(
        ...
        'order_type', ld_order_type.list_data,
