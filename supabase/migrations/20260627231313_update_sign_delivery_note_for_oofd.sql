-- Synced from QVM/test branch applied migration history (version 20260627231313, name: update_sign_delivery_note_for_oofd)
BEGIN;
...
GRANT EXECUTE ON FUNCTION public.sign_delivery_note(text, text, uuid) TO authenticated;
