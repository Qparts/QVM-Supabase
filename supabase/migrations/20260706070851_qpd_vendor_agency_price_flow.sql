-- Synced from QVM/test branch applied migration history (version 20260706070851, name: qpd_vendor_agency_price_flow)
-- Per-vendor agency (list) price on the vendor pricing row.
