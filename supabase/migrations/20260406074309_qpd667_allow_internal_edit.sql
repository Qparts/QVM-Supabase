-- Synced from QVM/test branch applied migration history (version 20260406074309, name: qpd667_allow_internal_edit)
-- QPD-667: Allow internal users (user_type=185) to edit profit margins
BEGIN;
