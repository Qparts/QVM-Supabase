...
-- a purchase order had since been raised on it. Seen on QVM/test on five quotations.
--
...
--
-- Function body is the live one on QVM/dev with these changes only (same change as the test
-- branch's 20260924120000).
