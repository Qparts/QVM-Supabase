-- Synced from QVM/test branch applied migration history (version 20260628222649, name: fix_purchase_invoices_join_by_confirmed_order)
...
BEGIN
  ...
  -- Latest PO per confirmed_order (for invoice number, uploaded_by, vendor_invoice_url)
  ...
  -- Latest credit note per confirmed_order (via purchase_order)
  ...
  -- All invoice attachments per confirmed_order
  ...
  -- All credit note attachments per confirmed_order (via purchase_order)
