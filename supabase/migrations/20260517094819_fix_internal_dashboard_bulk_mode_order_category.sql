-- Synced from QVM/test branch applied migration history (version 20260517094819, name: fix_internal_dashboard_bulk_mode_order_category)
...
BEGIN
  ...
  filtered_with_branch AS (
    SELECT
      ...
      CASE WHEN cb.order_category = 209 THEN true WHEN cb.order_category = 208 THEN false ELSE NULL END AS is_bulk_client,
