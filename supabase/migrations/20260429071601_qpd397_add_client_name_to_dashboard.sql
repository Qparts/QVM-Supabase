-- Synced from QVM/test branch applied migration history (version 20260429071601, name: qpd397_add_client_name_to_dashboard)
-- Add client_name to the Returns & Exchanges dashboard RPC
-- This allows displaying the client name as a caption beneath the branch name
